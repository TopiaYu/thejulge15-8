...
const Header = () => {
  ...
  return (
    <header className="w-full md:h-[70px] h-[102px] grid grid-cols-2 grid-rows-2 md:flex md:items-center md:justify-between xl:px-[208px] md:px-16 sm:px-8 px-5 md:pt-0 pt-[18px]">
      <div className="relative sm:w-[108px] sm:h-[20px] w-[84px] h-[30px] md:mr-10 mr-[35px] col-start-1 row-start-1 md:mt-0">
      ...
      <div className="flex font-bold text-base leading-5 lg:gap-10 sm:gap-3 gap-4 col-start-2 row-start-1 ml-auto text-[14px] sm:text-[16px] sm:leading-[20px]">
